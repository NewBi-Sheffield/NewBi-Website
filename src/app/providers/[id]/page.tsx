              ...
              {provider.phone && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${provider.phone}`} className="text-[#45c97a] font-semibold hover:underline text-sm">
                      {provider.phone}
                    </a>
                  </div>
                </div>
              ...
              {provider.email && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${provider.email}`} className="text-[#45c97a] font-semibold hover:underline text-sm break-all">
                      {provider.email}
                    </a>
                  </div>
                </div>
