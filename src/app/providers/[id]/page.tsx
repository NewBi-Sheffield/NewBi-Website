        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="bg-[#0f2236] rounded-2xl border border-white/10 p-6">
            <div className="flex items-start justify-between gap-3 mb-4">
              <span className="inline-block text-sm font-medium text-[#a5de57] bg-[#a5de57]/10 px-3 py-1 rounded-full">
                {provider.category}
              </span>
          ...
          <div className="bg-[#0f2236] rounded-2xl border border-white/10 p-6">
            ...
            <div className="flex flex-col gap-4">
              {provider.phone && (
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#a5de57] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <a href={`tel:${provider.phone}`} className="text-[#a5de57] font-semibold hover:underline text-sm">
                      {provider.phone}
                    </a>
                  </div>
                </div>
              ...
              {provider.email && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${provider.email}`} className="text-[#a5de57] font-semibold hover:underline text-sm break-all">
                      {provider.email}
                    </a>
                  </div>
                </div>
              ...
              {provider.address && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold text-sm">{provider.address}</p>
                  </div>
                </div>
              )}
              ...
              {provider.instagram && (
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#a5de57] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-[#a5de57] font-semibold hover:underline text-sm break-all"
                    >
            ...
            {(provider.instagram ?? provider.email) && (
              <a
                ...
                className="mt-6 flex items-center justify-center gap-2 w-full bg-gradient-to-r from-[#125a40] to-[#a5de57] text-white font-semibold py-3 rounded-xl text-sm hover:opacity-90 active:scale-95 transition-all"
              >
