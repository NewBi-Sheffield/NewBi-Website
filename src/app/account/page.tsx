...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="bg-[#0a1929] border border-white/8 rounded-xl px-6 py-5">
...
const btnClass =
  "self-start bg-gradient-to-r from-[#45c97a] to-[#3d88c4] text-white text-sm font-semibold px-4 py-2 rounded-xl hover:opacity-90 transition-opacity disabled:opacity-60 disabled:cursor-not-allowed";
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Section title="Danger zone">
        <p className="text-xs text-slate-400 mb-3">Permanently delete your account and all associated data. This cannot be undone.</p>
...
function ListingTab() {
  ...
  if (!providerData) return <p className="text-sm text-slate-500">No listing found for your account.</p>;
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {isUnlisted && (
        <div className="bg-slate-500/10 border border-slate-500/25 rounded-xl px-4 py-3 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-300">Your listing is unlisted</p>
      ...
      <div className="bg-[#0a1929] border border-white/8 rounded-xl px-6 py-5">
        {isVisible && (
          <p className="text-xs text-slate-400 mb-5">Changes are visible on the site immediately.</p>
        )}
        <ProviderForm
          initialData={{
    ...
    return (
      <div className="min-h-screen bg-[#080f18]">
        <div className="max-w-lg mx-auto px-4 py-10">
          <div className="mb-6">
            <Link href="/" className="text-xs text-slate-500 hover:text-white transition-colors">← Back to site</Link>
            <h1 className="text-lg font-bold text-white mt-3">My account</h1>
  ...
  return (
    <div className="min-h-screen bg-[#080f18] flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="px-8 py-5 border-b border-white/8">
