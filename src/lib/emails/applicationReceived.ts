      ...
      <table width="100%" style="max-width:520px;background:#FFFAF8;border-radius:16px;border:1px solid rgba(44,26,31,0.10);overflow:hidden;">
        ...
        <tr>
          <td style="padding:32px;">
            <p style="margin:0 0 8px;font-size:20px;font-weight:700;color:#2D1A1F;">Application received</p>
            <p style="margin:0 0 24px;font-size:14px;color:#9E7580;line-height:1.6;">
              Hi ${name}, thanks for applying to list <strong style="color:#2D1A1F;">${businessName}</strong> on NewBi.
              Our team will review your application and you'll hear back from us shortly.
            </p>
            <p style="margin:0;font-size:13px;color:#B09098;line-height:1.6;">
